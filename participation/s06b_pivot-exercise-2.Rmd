...
which(complete.cases(family) == FALSE)
which(complete.cases(family_long) == FALSE)
which(complete.cases(family_longest) == FALSE)

```

Question: Is is easier to easier to find the missing data in the wide or long format?

Answer: it's much easier in the wide format, given that the ids map onto the row numbers.
